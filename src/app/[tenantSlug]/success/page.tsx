...
import { CheckCircle2, QrCode, ArrowRight, Clock, ShieldCheck, Download, Share2, Mail, Loader2, Check } from "lucide-react";
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/notifications/send-pass", {
        ...
        body: JSON.stringify({ orderId: orderNumber, passToken: securityToken }),
      });
